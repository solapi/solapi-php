...
$mainImageId = $messageService->uploadFile(__DIR__ . '/images/main-2to1.jpg', 'BMS_WIDE_MAIN_ITEM_LIST');
$subImageId = $messageService->uploadFile(__DIR__ . '/images/sub-1to1.jpg', 'BMS_WIDE_SUB_ITEM_LIST');
